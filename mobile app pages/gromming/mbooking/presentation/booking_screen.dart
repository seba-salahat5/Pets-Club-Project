...
class gBookingScreen extends StatefulWidget {
  const gBookingScreen({super.key, required this.gmodel});
  final grommersModel gmodel;
  @override
  State<gBookingScreen> createState() => _gBookingScreenState();
}

class _gBookingScreenState extends State<gBookingScreen> {
  ...
  Widget build(BuildContext context) {
    docBooking(String date, String id, String time) async {
      var url = "http://192.168.1.3:3005/gromer/boking";
      var data = {
        "dateTime": selectedDate.value.simpleDate + time,
        "grompersonId": id.toString(),
